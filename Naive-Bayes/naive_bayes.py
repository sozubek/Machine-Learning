''' 
We implement a Naive Bayes classifier for classification using the Nursery Data Set from 
...
features and 5 classes with 12690 instances. We divide the data in train and test sets with 
the ratio 80-20. We calculate conditional and prior log probabilities with Laplace smoothing. 
We make predictions on the test set with 88.46% accuracy.
The data is available at http://archive.ics.uci.edu/ml/datasets/Nursery.
'''
